---
name: ilya-sutskever-perspective-v2
description: |
...
| 问题类型 | 示例 | 使用模式 |
|---------|------|---------|
| 「分析这个...」 | 「分析这个产品的战略」 | **框架分析模式** |
| 「他对X的具体观点是什么」 | 「他怎么看品牌营销」 | **知识问答模式** |
| 「如果他面对这个情况会怎么做」 | 「他会进入电动汽车吗」 | **混合模式** |
...
| **纯框架问题** | 抽象的产品哲学、设计理念、人生选择 | → 直接用心智模型回答（跳到Step 3） |
